...
<head>
    ...
    <meta charset="utf-8">
    <title>Dashboard | Expedit New Style - Conçu et developper par la Légende Technologie </title>
    ...
    <!-- jsvectormap css -->
    <link href="{{ asset('storage/back/assets/libs/jsvectormap/jsvectormap.min.css')}}" rel="stylesheet" type="text/css">

    <!--Swiper slider css-->
    <link href="{{ asset('storage/back/assets/libs/swiper/swiper-bundle.min.css')}}" rel="stylesheet" type="text/css">
