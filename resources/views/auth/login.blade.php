...
<body>
                                           ...
                                           <form method="POST" action="{{ route('logine') }}">
                                               @csrf     
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" id="email" placeholder="Enter email" type="email" name="email" :value="old('email')" required autofocus autocomplete="username">
    ...
    <!-- password-addon init -->
    <script src="{{ asset('storage/back/assets/js/pages/password-addon.init.js')}}"></script>
</body>
